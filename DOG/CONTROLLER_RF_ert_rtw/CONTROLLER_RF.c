...
void CONTROLLER_RF_step(void)
{
   ...
   */
  rtY.RF_theta_out = (rtb_y - rtb_x) * 0.017453292519943295;

  /* Outport: '<Root>/RF_theta_in' incorporates:
   *  Gain: '<S4>/Gain1'
   *  MATLAB Function: '<S1>/MATLAB Function1'
   */
  rtY.RF_theta_in = (rtb_y + rtb_x) * 0.017453292519943295;
}

/* Model initialize function */
void CONTROLLER_RF_initialize(void)
{
